...
def p_eval(t):
    '''
    EVAL = ID ON SIGNAL_LIST WITH INTVL_LIST |
           ID ON PROBSIGNAL_LIST WITH INTVL_LIST |
           ID WITH INTVL_LIST ON SIGNAL_LIST |
           ID WITH INTVL_LIST ON PROBSIGNAL_LIST
    '''
    t[0] = ('EVAL', t[0])
